...
class MobileDetect
{
    ...
    protected static $phoneDevices = [
        ...
        'Vertu' => 'Vertu|Vertu.*Ltd|Vertu.*Ascent|Vertu.*Ayxta|Vertu.*public constellation(F|Quest)?|Vertu.*Monika|Vertu.*Signature', // Just for fun ;)
     ...
     * expression defined in the public constant self::VER.
     *
     * @var array
     */
     ...
     *
     * See: http://docs.aws.amazon.com/AmazonCloudFront/latest/DeveloperGuide/header-caching.html#header-caching-web-device
     *
     ...
     * The type. Must be a self::DETECTION_TYPE_* public constant.
     * The default parameter is null which will default to self::DETECTION_TYPE_MOBILE.
     *
     * @param string $type
     */
    ...
    /**
     * Retrieve the mobile grading, using self::MOBILE_GRADE_* public constants.
     *
     * @return string one of the self::MOBILE_GRADE_* public constants
     */
